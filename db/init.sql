...
CREATE TABLE `online_user`  (
  ...
  `token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'jwt生成的token',
  ...
  `online_status` tinyint NULL DEFAULT NULL COMMENT '在线状态',
  `last_active_time` datetime NULL DEFAULT NULL COMMENT '最后访问时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_menu`  (
  ...
  `deleted` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 187 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (186, '在线用户', 'admin/monitor/onlineuser/index', 'admin/monitor/onlineuser/index', NULL, 142, 'fa fa-user-circle', 1, 1, NULL, 2, '2025-04-10 09:43:38', 'admin', '2025-04-10 09:46:18', 'admin', 0);
...
INSERT INTO `sys_menu_resource_rel` VALUES (186, 91);
...
CREATE TABLE `sys_resource`  (
  ...
  `deleted` int(1) UNSIGNED ZEROFILL NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 92 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资源表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_resource` VALUES (91, '在线用户列表', '/admin/online-user/list', '2025-04-10 09:45:43', 'admin', '2025-04-10 09:45:43', 'admin', 0);
