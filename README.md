...
|                   |                                                              |          |
| **多租户架构**    | 支持多租户配置和管理，实现用户、数据资源的完全隔离           | 🚧 开发中 |
...
<table>
    ...
    <tr>
        ...
        <td><img src="screenshots/AI聊天.png" alt="AI聊天"/></td>
    </tr>
    <tr>
        <td><img src="screenshots/模型配置.png" alt="模型配置"/></td>
        <td><img src="screenshots/数据库知识库.png" alt="数据库知识库"/></td>
    </tr>
    <tr>
        <td><img src="screenshots/元数据.png" alt="元数据"/></td>
        <td><img src="screenshots/角色与提示词.png" alt="角色与提示词"/></td>
    </tr>
</table>
