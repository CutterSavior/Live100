...
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public MultiRequestBodyArgumentResolver(SmartValidator validator) {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        if (value != null) {
            ...
            // 其他复杂对象
            Object o = JSON.parseObject(value.toString(), parameter.getGenericParameterType());
            validate(parameter, o);
            return o;
        }
...
//            }
    ...
    private void validate(MethodParameter parameter, Object instance) throws MethodArgumentNotValidException {
        if (parameter.hasParameterAnnotation(Validated.class)) {
            BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(instance, parameter.getParameterName());
